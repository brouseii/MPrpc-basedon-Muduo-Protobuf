...
template<> ::fixbug::SignupRequest* Arena::CreateMaybeMessage<::fixbug::SignupRequest>(Arena*);
template<> ::fixbug::SignupResponse* Arena::CreateMaybeMessage<::fixbug::SignupResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace fixbug {
...
class SignupRequest :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.SignupRequest) */ {
 public:
  SignupRequest();
  ...
  // @@protoc_insertion_point(class_scope:fixbug.SignupRequest)
 private:
  class _Internal;
...
class SignupResponse :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.SignupResponse) */ {
 public:
  SignupResponse();
  ...
  // @@protoc_insertion_point(class_scope:fixbug.SignupResponse)
 private:
  class _Internal;
...
class UserServiceRpc : public ::PROTOBUF_NAMESPACE_ID::Service {
 ...
 public:
  ...
  virtual void Signup(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
...
class UserServiceRpc_Stub : public UserServiceRpc {
 public:
  ...
  void Login(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                       ...
                       ::fixbug::LoginResponse* response,
                       ::google::protobuf::Closure* done);
  void Signup(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                       const ::fixbug::SignupRequest* request,
                       ::fixbug::SignupResponse* response,
                       ::google::protobuf::Closure* done);
 private:
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 LoginRequest::_internal_id() const {
  return id_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 LoginRequest::id() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginRequest.id)
  return _internal_id();
}
inline void LoginRequest::_internal_set_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  id_ = value;
}
inline void LoginRequest::set_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_id(value);
  // @@protoc_insertion_point(field_set:fixbug.LoginRequest.id)
}
...
inline const std::string& SignupRequest::name() const {
  // @@protoc_insertion_point(field_get:fixbug.SignupRequest.name)
  return _internal_name();
}
inline void SignupRequest::set_name(const std::string& value) {
  _internal_set_name(value);
  // @@protoc_insertion_point(field_set:fixbug.SignupRequest.name)
}
inline std::string* SignupRequest::mutable_name() {
  // @@protoc_insertion_point(field_mutable:fixbug.SignupRequest.name)
  return _internal_mutable_name();
}
inline const std::string& SignupRequest::_internal_name() const {
  return name_.GetNoArena();
}
inline void SignupRequest::_internal_set_name(const std::string& value) {
...
inline void SignupRequest::set_name(std::string&& value) {
  ...
  name_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:fixbug.SignupRequest.name)
}
inline void SignupRequest::set_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:fixbug.SignupRequest.name)
}
inline void SignupRequest::set_name(const void* value, size_t size) {
  
  name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:fixbug.SignupRequest.name)
}
inline std::string* SignupRequest::_internal_mutable_name() {
  
  return name_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* SignupRequest::release_name() {
  // @@protoc_insertion_point(field_release:fixbug.SignupRequest.name)
...
inline void SignupRequest::set_allocated_name(std::string* name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:fixbug.SignupRequest.name)
}

// bytes pwd = 2;
inline void SignupRequest::clear_pwd() {
  pwd_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& SignupRequest::pwd() const {
  // @@protoc_insertion_point(field_get:fixbug.SignupRequest.pwd)
  return _internal_pwd();
}
inline void SignupRequest::set_pwd(const std::string& value) {
  _internal_set_pwd(value);
  // @@protoc_insertion_point(field_set:fixbug.SignupRequest.pwd)
}
inline std::string* SignupRequest::mutable_pwd() {
  // @@protoc_insertion_point(field_mutable:fixbug.SignupRequest.pwd)
  return _internal_mutable_pwd();
}
inline const std::string& SignupRequest::_internal_pwd() const {
  return pwd_.GetNoArena();
}
inline void SignupRequest::_internal_set_pwd(const std::string& value) {
  
  pwd_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void SignupRequest::set_pwd(std::string&& value) {
  
  pwd_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:fixbug.SignupRequest.pwd)
}
inline void SignupRequest::set_pwd(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  pwd_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:fixbug.SignupRequest.pwd)
}
inline void SignupRequest::set_pwd(const void* value, size_t size) {
  
  pwd_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:fixbug.SignupRequest.pwd)
}
inline std::string* SignupRequest::_internal_mutable_pwd() {
  
  return pwd_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* SignupRequest::release_pwd() {
  // @@protoc_insertion_point(field_release:fixbug.SignupRequest.pwd)
  
  return pwd_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void SignupRequest::set_allocated_pwd(std::string* pwd) {
  if (pwd != nullptr) {
  ...
  pwd_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), pwd);
  // @@protoc_insertion_point(field_set_allocated:fixbug.SignupRequest.pwd)
}
...
// .fixbug.ResultCode result = 1;
inline bool SignupResponse::_internal_has_result() const {
  return this != internal_default_instance() && result_ != nullptr;
}
inline bool SignupResponse::has_result() const {
  return _internal_has_result();
}
inline void SignupResponse::clear_result() {
  if (GetArenaNoVirtual() == nullptr && result_ != nullptr) {
    delete result_;
  }
  result_ = nullptr;
}
inline const ::fixbug::ResultCode& SignupResponse::_internal_result() const {
  const ::fixbug::ResultCode* p = result_;
  return p != nullptr ? *p : *reinterpret_cast<const ::fixbug::ResultCode*>(
      &::fixbug::_ResultCode_default_instance_);
}
inline const ::fixbug::ResultCode& SignupResponse::result() const {
  // @@protoc_insertion_point(field_get:fixbug.SignupResponse.result)
  return _internal_result();
}
inline ::fixbug::ResultCode* SignupResponse::release_result() {
  // @@protoc_insertion_point(field_release:fixbug.SignupResponse.result)
  
  ::fixbug::ResultCode* temp = result_;
  result_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* SignupResponse::_internal_mutable_result() {
...
inline ::fixbug::ResultCode* SignupResponse::mutable_result() {
  // @@protoc_insertion_point(field_mutable:fixbug.SignupResponse.result)
  return _internal_mutable_result();
}
inline void SignupResponse::set_allocated_result(::fixbug::ResultCode* result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete result_;
  }
  ...
  result_ = result;
  // @@protoc_insertion_point(field_set_allocated:fixbug.SignupResponse.result)
}
...
inline bool SignupResponse::success() const {
  // @@protoc_insertion_point(field_get:fixbug.SignupResponse.success)
  return _internal_success();
}
...
inline void SignupResponse::set_success(bool value) {
  _internal_set_success(value);
  // @@protoc_insertion_point(field_set:fixbug.SignupResponse.success)
}
