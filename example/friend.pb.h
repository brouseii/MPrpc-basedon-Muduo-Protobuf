...
class GetFriendListsResponse :
 ...
 public:
  ...
  const std::string& friendlists(int index) const;
  std::string* mutable_friendlists(int index);
  void set_friendlists(int index, const std::string& value);
  void set_friendlists(int index, std::string&& value);
  void set_friendlists(int index, const char* value);
  void set_friendlists(int index, const void* value, size_t size);
  std::string* add_friendlists();
  void add_friendlists(const std::string& value);
  void add_friendlists(std::string&& value);
  void add_friendlists(const char* value);
  void add_friendlists(const void* value, size_t size);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& friendlists() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* mutable_friendlists();
  private:
  const std::string& _internal_friendlists(int index) const;
  std::string* _internal_add_friendlists();
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string> friendlists_;
...
inline std::string* GetFriendListsResponse::add_friendlists() {
  // @@protoc_insertion_point(field_add_mutable:fixbug.GetFriendListsResponse.friendlists)
  return _internal_add_friendlists();
}
inline const std::string& GetFriendListsResponse::_internal_friendlists(int index) const {
  return friendlists_.Get(index);
}
inline const std::string& GetFriendListsResponse::friendlists(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsResponse.friendlists)
  return _internal_friendlists(index);
}
inline std::string* GetFriendListsResponse::mutable_friendlists(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListsResponse.friendlists)
  return friendlists_.Mutable(index);
}
inline void GetFriendListsResponse::set_friendlists(int index, const std::string& value) {
  // @@protoc_insertion_point(field_set:fixbug.GetFriendListsResponse.friendlists)
  friendlists_.Mutable(index)->assign(value);
}
inline void GetFriendListsResponse::set_friendlists(int index, std::string&& value) {
  // @@protoc_insertion_point(field_set:fixbug.GetFriendListsResponse.friendlists)
  friendlists_.Mutable(index)->assign(std::move(value));
}
inline void GetFriendListsResponse::set_friendlists(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  friendlists_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:fixbug.GetFriendListsResponse.friendlists)
}
inline void GetFriendListsResponse::set_friendlists(int index, const void* value, size_t size) {
  friendlists_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:fixbug.GetFriendListsResponse.friendlists)
}
inline std::string* GetFriendListsResponse::_internal_add_friendlists() {
  return friendlists_.Add();
}
inline void GetFriendListsResponse::add_friendlists(const std::string& value) {
  friendlists_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListsResponse.friendlists)
}
inline void GetFriendListsResponse::add_friendlists(std::string&& value) {
  friendlists_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListsResponse.friendlists)
}
inline void GetFriendListsResponse::add_friendlists(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  friendlists_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:fixbug.GetFriendListsResponse.friendlists)
}
inline void GetFriendListsResponse::add_friendlists(const void* value, size_t size) {
  friendlists_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:fixbug.GetFriendListsResponse.friendlists)
}
